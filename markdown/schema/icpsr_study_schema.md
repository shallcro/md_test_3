...
Metadata Schema for Curated ICPSR Studies as of August 31, 2023.
...
**Description:** The URL of the item being linked to. Restricted to ICPSR 'union catalog' records – i.e., external resource to which ICPSR links as a courtesy.
...
**Curator Notes:** This field is displayed to end-users in version history.

### <a name="autogenerated_heading_18"></a>29.1. Items
